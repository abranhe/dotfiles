...
goto() (
  help() {
    ...
    echo
    echo "Options:"   
    echo "  b    bitbucket         Navigate to ~/bitbucket/"
    echo "  g    github            Navigate to ~/github"
    echo "  se   smarteat          Navigate to ~/bitbucket/smarteat/"
    echo
    echo "Flags:"
    echo "  -h   --help               Display help information"
    echo
...
cmds() {
  ...
  ${COLOR_B_CYAN}COMMANDS:${nc}
    ...
    ${a}■${nc} simulator          Open iOS simulator
    ...
    ${u}■${nc} rn-clean           Clean react native
